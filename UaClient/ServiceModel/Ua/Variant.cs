...
public readonly struct Variant
{
    ...
    private static readonly Dictionary<Type, VariantType> typeMap = new()
    {
    ...
    private static readonly Dictionary<Type, VariantType> elemTypeMap = new()
    {
        [typeof(bool)] = VariantType.Boolean,
        [typeof(sbyte)] = VariantType.SByte,
        [typeof(byte)] = VariantType.Byte,
    ...
    public Variant(object? value)
    {
        ...
        if (value is Array array)
        {
            ...
            if (elemTypeMap.TryGetValue(elemType, out variantType))
            {
                ...
                for (var i = 0; i < array.Rank; i++) ArrayDimensions[i] = array.GetLength(i);
    ...
    public Variant(bool[]? value)
    {
        ...
        for (var i = 0; i < value.Rank; i++) ArrayDimensions[i] = value.GetLength(i);
    }
