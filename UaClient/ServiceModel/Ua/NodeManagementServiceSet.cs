...
public static class NodeManagementServiceSet
{
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.7.2/">
    ...
    ///     <see cref="AddReferencesResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.7.3/">
    ///     OPC UA specification Part 4: Services,
    ///     5.7.3
    /// </seealso>
    public static async Task<AddReferencesResponse> AddReferencesAsync(this IRequestChannel channel,
        AddReferencesRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="DeleteNodesResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.7.4/">
    ///     OPC UA specification Part 4: Services,
    ///     5.7.4
    /// </seealso>
    public static async Task<DeleteNodesResponse> DeleteNodesAsync(this IRequestChannel channel,
        DeleteNodesRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="DeleteReferencesResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.7.5/">
    ///     OPC UA specification Part 4: Services,
    ///     5.7.5
    /// </seealso>
    public static async Task<DeleteReferencesResponse> DeleteReferencesAsync(this IRequestChannel channel,
        DeleteReferencesRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
