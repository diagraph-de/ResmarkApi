...
{
    private readonly Dictionary<uint, MonitoredItemBase> _clientIdMap = new();
    private readonly Dictionary<string, MonitoredItemBase> _nameMap = new();
    ...
    /// <returns>
    ///     The element with the specified name. If an element with the specified key is not found, an exception is
    ///     thrown.
    /// </returns>
    ...
    ///     An element with the specified name does not exist
    ///     in the collection.
    /// </exception>
    public MonitoredItemBase this[string name]
    {
        get
        {
            ...
            if (_nameMap.TryGetValue(name, out var item)) return item;
    ...
    /// <returns>
    ///     The element with the specified clientId. If an element with the specified key is not found, an exception is
    ///     thrown.
    /// </returns>
    /// <param name="clientId">The clientId of the element to get.</param>
    /// <exception cref="T:System.ArgumentNullException">
    ///     <paramref name="clientId" /> is null.
    /// </exception>
    /// <exception cref="T:System.Collections.Generic.KeyNotFoundException">
    ///     An element with the specified clientId does not
    ...
    public MonitoredItemBase this[uint clientId]
    {
        get
        {
            if (_clientIdMap.TryGetValue(clientId, out var item)) return item;
    ...
    /// <returns>
    ///     true if the <see cref="MonitoredItemBaseCollection" /> contains an element with the specified name; otherwise,
    ///     false.
    /// </returns>
    ...
    /// </param>
    public bool TryGetValueByName(string name, [NotNullWhen(true)] out MonitoredItemBase? value)
    {
    ...
    /// <returns>
    ///     true if the <see cref="MonitoredItemBaseCollection" /> contains an element with the specified clientId;
    ///     otherwise, false.
    /// </returns>
    ...
    ///     passed uninitialized.
    /// </param>
    public bool TryGetValueByClientId(uint clientId, [NotNullWhen(true)] out MonitoredItemBase? value)
    {
