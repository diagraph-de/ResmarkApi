...
public interface ICertificateStore
{
    ...
    Task<(X509Certificate? Certificate, RsaKeyParameters? Key)> GetLocalCertificateAsync(
        ApplicationDescription applicationDescription, ILogger? logger, CancellationToken token);
