...
public static class QueryServiceSet
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a <see cref="QueryFirstResponse" />
    ///     .
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.9.3/">
    ///     OPC UA specification Part 4: Services,
    ///     5.9.3
    /// </seealso>
    public static async Task<QueryFirstResponse> QueryFirstAsync(this IRequestChannel channel,
        QueryFirstRequest request, CancellationToken token = default)
    {
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.9.4/">
    ///     OPC UA specification Part 4: Services,
    ///     5.9.4
    /// </seealso>
