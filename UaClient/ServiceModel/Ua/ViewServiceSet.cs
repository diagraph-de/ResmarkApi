...
public static class ViewServiceSet
{
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.8.2/">
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a <see cref="BrowseNextResponse" />
    ///     .
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.8.3/">
    ///     OPC UA specification Part 4: Services,
    ///     5.8.3
    /// </seealso>
    public static async Task<BrowseNextResponse> BrowseNextAsync(this IRequestChannel channel,
        BrowseNextRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    ///     <see cref="TranslateBrowsePathsToNodeIdsResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.8.4/">
    ///     OPC UA specification Part 4: Services,
    ///     5.8.4
    /// </seealso>
    public static async Task<TranslateBrowsePathsToNodeIdsResponse> TranslateBrowsePathsToNodeIdsAsync(
        this IRequestChannel channel, TranslateBrowsePathsToNodeIdsRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="RegisterNodesResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.8.5/">
    ///     OPC UA specification Part 4: Services,
    ///     5.8.5
    /// </seealso>
    public static async Task<RegisterNodesResponse> RegisterNodesAsync(this IRequestChannel channel,
        RegisterNodesRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="UnregisterNodesResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.8.6/">
    ///     OPC UA specification Part 4: Services,
    ///     5.8.6
    /// </seealso>
    public static async Task<UnregisterNodesResponse> UnregisterNodesAsync(this IRequestChannel channel,
        UnregisterNodesRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
