...
public interface IConversation
{
    ...
    Task EncryptMessageAsync(Stream bodyStream, uint messageType, uint requestHandle,
    ...
    Task<(uint messageType, uint requestHandle)> DecryptMessageAsync(Stream bodyStream,
