...
/// </summary>
/// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.1/">
...
public sealed class BinaryDecoder : IDecoder, IDisposable
{
    ...
    private static readonly NodeId _publishResponseNodeId =
        NodeId.Parse(ObjectIds.PublishResponse_Encoding_DefaultBinary);
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.1">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.1
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.2">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.2
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.3">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.3
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.4">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.4
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.5">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.5
    /// </seealso>
    public DateTime ReadDateTime(string? fieldName)
    {
        var num = _reader.ReadInt64();

        if (num <= 0) return DateTime.MinValue;

        if (num >= _maxFileTime - _minFileTime) return DateTime.MaxValue;
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.6">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.6
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.7">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.7
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.8">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.8
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.9">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.9
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.10">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.10
    /// </seealso>
    public ExpandedNodeId ReadExpandedNodeId(string? fieldName)
    {
        ...
        switch (b & 0x0F)
        {
            ...
            case 0x03:
                ns = _reader.ReadUInt16();
                if (ReadString(null) is { } str) nodeId = new NodeId(str, ns);
                break;
            ...
            case 0x05:
                ns = _reader.ReadUInt16();
                if (ReadByteString(null) is { } bstr) nodeId = new NodeId(bstr, ns);
                break;
        }

        if (nodeId is null) throw new ServiceResultException(StatusCodes.BadDecodingError);

        if ((b & 0x80) != 0) nsu = ReadString(null);

        if ((b & 0x40) != 0) svr = ReadUInt32(null);
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.11">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.11
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.12">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.12
    /// </seealso>
    public DiagnosticInfo ReadDiagnosticInfo(string? fieldName)
    {
        ...
        var innerStatusCode = default(StatusCode);
        var innerDiagnosticInfo = default(DiagnosticInfo);
        var b = _reader.ReadByte();
        if ((b & 1) != 0) symbolicId = ReadInt32(null);

        if ((b & 2) != 0) namespaceUri = ReadInt32(null);

        if ((b & 8) != 0) locale = ReadInt32(null);

        if ((b & 4) != 0) localizedText = ReadInt32(null);

        if ((b & 16) != 0) additionalInfo = ReadString(null);

        if ((b & 32) != 0) innerStatusCode = ReadStatusCode(null);

        if ((b & 64) != 0) innerDiagnosticInfo = ReadDiagnosticInfo(null);

        return new DiagnosticInfo(namespaceUri, symbolicId, locale, localizedText, additionalInfo, innerStatusCode,
            innerDiagnosticInfo);
    }
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.13">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.13
    /// </seealso>
    public QualifiedName ReadQualifiedName(string? fieldName)
    {
        var ns = ReadUInt16(null);
        var name = ReadString(null);
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.14">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.14
    /// </seealso>
    public LocalizedText ReadLocalizedText(string? fieldName)
    {
        ...
        string? locale = null;
        var b = _reader.ReadByte();
        if ((b & 1) != 0) locale = ReadString(null);

        if ((b & 2) != 0) text = ReadString(null);
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.16">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.16
    /// </seealso>
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.17">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.17
    /// </seealso>
    public DataValue ReadDataValue(string? fieldName)
    {
        ...
        var sourceTimestamp = DateTime.MinValue;
        ushort sourcePicoseconds = 0;
        var serverTimestamp = DateTime.MinValue;
        ushort serverPicoseconds = 0;
        var b = _reader.ReadByte();
        if ((b & 1) != 0) variant = ReadVariant(null);

        if ((b & 2) != 0) statusCode = ReadStatusCode(null);

        if ((b & 4) != 0) sourceTimestamp = ReadDateTime(null);

        if ((b & 16) != 0) sourcePicoseconds = ReadUInt16(null);

        if ((b & 8) != 0) serverTimestamp = ReadDateTime(null);

        if ((b & 32) != 0) serverPicoseconds = ReadUInt16(null);

        return new DataValue(variant, statusCode, sourceTimestamp, sourcePicoseconds, serverTimestamp,
            serverPicoseconds);
    }
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.2/#5.2.2.15">
    ///     OPC UA specification Part 6:
    ///     Mappings, 5.2.2.15
    /// </seealso>
    public ExtensionObject? ReadExtensionObject(string? fieldName)
    {
        try
        {
            var nodeId = ReadNodeId(null);
            var b = _reader.ReadByte();
            if (b == (byte)BodyType.ByteString) // BodyType Encodable is encoded as ByteString.
            {
                var binaryEncodingId = NodeId.ToExpandedNodeId(nodeId, _context.NamespaceUris);
            ...
            {
                var xmlEncodingId = NodeId.ToExpandedNodeId(nodeId, _context.NamespaceUris);
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.6/">
    ///     OPC UA specification Part 6: Mappings,
    ///     5.2.6
    /// </seealso>
    ...
    /// </summary>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.9/">
    ///     OPC UA specification Part 6: Mappings,
    ///     5.2.9
    /// </seealso>
    public IServiceResponse ReadResponse()
    {
        try
        {
            ...
            {
                if (!TypeLibrary.TryGetTypeFromBinaryEncodingId(NodeId.ToExpandedNodeId(nodeId, _context.NamespaceUris),
                        out var type)) throw new ServiceResultException(StatusCodes.BadEncodingError);
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>The value.</returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.4/">
    ///     OPC UA specification Part 6: Mappings,
    ///     5.2.4
    /// </seealso>
    ...
    ///     Mappings, 5.2.2.1
    /// </seealso>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part6/5.2.5/">
    ///     OPC UA specification Part 6: Mappings,
    ///     5.2.5
    /// </seealso>
    public bool[]? ReadBooleanArray(string? fieldNames)
    {
        var num = ReadArrayLength();
        if (num == -1) return null;

        var list = new bool[num];
        for (var i = 0; i < num; i++) list[i] = ReadBoolean(null);
    ...
    public sbyte[]? ReadSByteArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadSByte(null);
    ...
    public byte[]? ReadByteArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadByte(null);
    ...
    public short[]? ReadInt16Array(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadInt16(null);
    ...
    public ushort[]? ReadUInt16Array(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadUInt16(null);
    ...
    public int[]? ReadInt32Array(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadInt32(null);
    ...
    public uint[]? ReadUInt32Array(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadUInt32(null);
    ...
    public long[]? ReadInt64Array(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadInt64(null);
    ...
    public ulong[]? ReadUInt64Array(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadUInt64(null);
    ...
    public float[]? ReadFloatArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadFloat(null);
    ...
    public double[]? ReadDoubleArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadDouble(null);
    ...
    public string?[]? ReadStringArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadString(null);
    ...
    public DateTime[]? ReadDateTimeArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadDateTime(null);
    ...
    public Guid[]? ReadGuidArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadGuid(null);
    ...
    public byte[]?[]? ReadByteStringArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadByteString(null);
    ...
    public XElement?[]? ReadXElementArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadXElement(null);
    ...
    public NodeId[]? ReadNodeIdArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadNodeId(null);
    ...
    public ExpandedNodeId[]? ReadExpandedNodeIdArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadExpandedNodeId(null);
    ...
    public StatusCode[]? ReadStatusCodeArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadStatusCode(null);
    ...
    public DiagnosticInfo[]? ReadDiagnosticInfoArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadDiagnosticInfo(null);
    ...
    public QualifiedName[]? ReadQualifiedNameArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadQualifiedName(null);
    ...
    public LocalizedText[]? ReadLocalizedTextArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadLocalizedText(null);
    ...
    public Variant[]? ReadVariantArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadVariant(null);
    ...
    public DataValue[]? ReadDataValueArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadDataValue(null);
    ...
    public ExtensionObject?[]? ReadExtensionObjectArray(string? fieldName)
    {
        ...
        for (var i = 0; i < num; i++) list[i] = ReadExtensionObject(null);
        ...
        where T : class, IEncodable
    {
        ...
        var list = new T?[num];
        for (var i = 0; i < num; i++) list[i] = ReadExtensionObject<T>(null);
        ...
        where T : class, IEncodable
    {
        ...
        var list = new T[num];
        for (var i = 0; i < num; i++) list[i] = ReadEncodable<T>(null);
        ...
        where T : struct, IConvertible
    {
        ...
        var list = new T[num];
        for (var i = 0; i < num; i++) list[i] = ReadEnumeration<T>(null);
    ...
    {
        if (a1 is null || dims is null) return default;
