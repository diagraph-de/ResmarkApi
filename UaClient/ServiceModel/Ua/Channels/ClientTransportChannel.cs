...
public class ClientTransportChannel : CommunicationObject
{
    ...
    /// <param name="token">A cancellation token.</param>
    /// <returns>A task.</returns>
    protected virtual async Task<int> ReceiveAsync(byte[] buffer, int offset, int count,
    ...
    protected override async Task OnOpenAsync(CancellationToken token)
    {
        ...
        _connection = await StackProfile.TransportConnectionProvider.ConnectAsync(RemoteEndpoint.EndpointUrl!, token)
