...
public static class AttributeServiceSet
{
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.10.2/">
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.10.4/">
    ///     OPC UA specification Part 4: Services,
    ///     5.10.4
    /// </seealso>
    ...
    ///     <see cref="HistoryReadResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.10.3/">
    ///     OPC UA specification Part 4: Services,
    ///     5.10.3
    /// </seealso>
    public static async Task<HistoryReadResponse> HistoryReadAsync(this IRequestChannel client,
        HistoryReadRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="HistoryUpdateResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.10.5/">
    ///     OPC UA specification Part 4: Services,
    ///     5.10.5
    /// </seealso>
    public static async Task<HistoryUpdateResponse> HistoryUpdateAsync(this IRequestChannel client,
        HistoryUpdateRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
