...
{
    public static readonly NodeId Null = new(0);
    ...
    ///     the index of the namespace in the NamespaceArray. An index of 0 corresponds to
    ...
    public static ExpandedNodeId ToExpandedNodeId(NodeId value, IReadOnlyList<string> namespaceUris)
    {
        ...
        if (ns == 0) return new ExpandedNodeId(value);
    ...
    public static bool TryParse(string s, [NotNullWhen(true)] out NodeId value)
    {
        try
        {
            ushort ns = 0;
    ...
    public override string ToString()
    {
        ...
        if (NamespaceIndex > 0) sb.AppendFormat("ns={0};", NamespaceIndex);
