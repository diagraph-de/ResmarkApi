...
public static class SubscriptionServiceSet
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="CreateSubscriptionResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.13.2/">
    ///     OPC UA specification Part 4: Services,
    ///     5.13.2
    /// </seealso>
    public static async Task<CreateSubscriptionResponse> CreateSubscriptionAsync(this IRequestChannel channel,
        CreateSubscriptionRequest request, CancellationToken token = default)
    {
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="ModifySubscriptionResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.13.3/">
    ///     OPC UA specification Part 4: Services,
    ///     5.13.3
    /// </seealso>
    public static async Task<ModifySubscriptionResponse> ModifySubscriptionAsync(this IRequestChannel channel,
        ModifySubscriptionRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="SetPublishingModeResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.13.4/">
    ///     OPC UA specification Part 4: Services,
    ///     5.13.4
    /// </seealso>
    public static async Task<SetPublishingModeResponse> SetPublishingModeAsync(this IRequestChannel channel,
        SetPublishingModeRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.13.5/">
    ///     OPC UA specification Part 4: Services,
    ///     5.13.5
    /// </seealso>
    ...
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.13.6/">
    ///     OPC UA specification Part 4: Services,
    ///     5.13.6
    /// </seealso>
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="TransferSubscriptionsResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.13.7/">
    ///     OPC UA specification Part 4: Services,
    ///     5.13.7
    /// </seealso>
    public static async Task<TransferSubscriptionsResponse> TransferSubscriptionsAsync(this IRequestChannel channel,
        TransferSubscriptionsRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
    ...
    /// <returns>
    ///     A <see cref="Task" /> representing the asynchronous operation that returns a
    ///     <see cref="DeleteSubscriptionsResponse" />.
    /// </returns>
    /// <seealso href="https://reference.opcfoundation.org/v104/Core/docs/Part4/5.13.8/">
    ///     OPC UA specification Part 4: Services,
    ///     5.13.8
    /// </seealso>
    public static async Task<DeleteSubscriptionsResponse> DeleteSubscriptionsAsync(this IRequestChannel channel,
        DeleteSubscriptionsRequest request, CancellationToken token = default)
    {
        if (request == null) throw new ArgumentNullException(nameof(request));
