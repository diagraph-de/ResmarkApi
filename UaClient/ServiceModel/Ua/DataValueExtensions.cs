    ...
    public static T GetValueOrDefault<T>(this DataValue dataValue)
    {
        ...
        switch (value)
        {
            ...
            case ExtensionObject[] objArray:
                ...
                try
                {
                    var v4 = typeof(Enumerable).GetMethod("Cast")!.MakeGenericMethod(elementType)
                        .Invoke(null, new object?[] { v3 });
                    var v5 = typeof(Enumerable).GetMethod("ToArray")!.MakeGenericMethod(elementType)
                        .Invoke(null, new[] { v4 });
                    if (v5 is T t2) return t2;
                    return default!;
                }
                catch (Exception)
                {
