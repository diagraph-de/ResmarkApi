...
public abstract class MonitoredItemBase
{
    ...
    public MonitoredItemBase(string name, ExpandedNodeId nodeId, uint attributeId = AttributeIds.Value,
        string? indexRange = null, MonitoringMode monitoringMode = MonitoringMode.Reporting, int samplingInterval = -1,
        MonitoringFilter? filter = null, uint queueSize = 0, bool discardOldest = true)
    {
...
public class DataValueMonitoredItem : MonitoredItemBase
{
    ...
    public DataValueMonitoredItem(object target, PropertyInfo property, ExpandedNodeId nodeId, uint attributeId = 13,
        string? indexRange = null, MonitoringMode monitoringMode = MonitoringMode.Reporting, int samplingInterval = -1,
        MonitoringFilter? filter = null, uint queueSize = 0, bool discardOldest = true)
        : base(property.Name, nodeId, attributeId, indexRange, monitoringMode, samplingInterval, filter, queueSize,
            discardOldest)
    {
    ...
    {
        if (this.statusCode == statusCode) return;
        ...
        if (targetAsDataErrorInfo != null)
        {
            if (!StatusCode.IsGood(statusCode))
                targetAsDataErrorInfo.SetErrors(Property.Name, new[] { StatusCodes.GetDefaultMessage(statusCode) });
            else
...
public class ValueMonitoredItem : MonitoredItemBase
{
    ...
    public ValueMonitoredItem(object target, PropertyInfo property, ExpandedNodeId nodeId, uint attributeId = 13,
        string? indexRange = null, MonitoringMode monitoringMode = MonitoringMode.Reporting, int samplingInterval = -1,
        MonitoringFilter? filter = null, uint queueSize = 0, bool discardOldest = true)
        : base(property.Name, nodeId, attributeId, indexRange, monitoringMode, samplingInterval, filter, queueSize,
            discardOldest)
...
public class DataValueQueueMonitoredItem : MonitoredItemBase
{
    ...
    public DataValueQueueMonitoredItem(object target, PropertyInfo property, ExpandedNodeId nodeId,
        uint attributeId = 13, string? indexRange = null, MonitoringMode monitoringMode = MonitoringMode.Reporting,
        int samplingInterval = -1, MonitoringFilter? filter = null, uint queueSize = 0, bool discardOldest = true)
        : base(property.Name, nodeId, attributeId, indexRange, monitoringMode, samplingInterval, filter, queueSize,
            discardOldest)
    {
        if (target == null) throw new ArgumentNullException(nameof(target));
...
public class EventMonitoredItem : MonitoredItemBase
{
    ...
    public EventMonitoredItem(object target, PropertyInfo property, ExpandedNodeId nodeId, uint attributeId = 12,
        string? indexRange = null, MonitoringMode monitoringMode = MonitoringMode.Reporting, int samplingInterval = -1,
        MonitoringFilter? filter = null, uint queueSize = 0, bool discardOldest = true)
        : base(property.Name, nodeId, attributeId, indexRange, monitoringMode, samplingInterval, filter, queueSize,
            discardOldest)
    ...
    where T : BaseEvent, new()
{
    ...
    public EventQueueMonitoredItem(object target, PropertyInfo property, ExpandedNodeId nodeId, uint attributeId = 12,
        string? indexRange = null, MonitoringMode monitoringMode = MonitoringMode.Reporting, int samplingInterval = -1,
        MonitoringFilter? filter = null, uint queueSize = 0, bool discardOldest = true)
        : base(property.Name, nodeId, attributeId, indexRange, monitoringMode, samplingInterval, filter, queueSize,
            discardOldest)
