...
public sealed class SubscriptionAttribute : Attribute
{
    ...
    public SubscriptionAttribute(string endpointUrl, double publishingInterval = 1000f, uint keepAliveCount = 10,
        uint lifetimeCount = 0, bool publishingEnabled = true)
    {
