...
/// <summary>
///     Defines the states in which an <see cref="T:ConverterSystems.ServiceModel.Ua.ICommunicationObject" /> can
///     exist.
/// </summary>
public enum CommunicationState
{
    /// <summary>
    ///     Indicates that the communication object has been instantiated and is configurable, but not yet open or ready
    ///     for use.
    /// </summary>
    Created,
    ...
    /// <summary>
    ///     Indicates that the communication object has encountered an error or fault from which it cannot recover and
    ///     from which it is no longer usable.
    /// </summary>
    Faulted
}